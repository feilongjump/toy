<template>
  <div
    class="fixed top-4 -left-24 sm:left-4 h-sidebar w-24 bg-white rounded-2xl px-2 py-4 transition-all duration-500 ease-in-out"
  >
    <div class="w-full h-full flex items-center justify-between flex-col">
      <div class="h-16 flex items-center">LOGO</div>
