    ...
    <div class="max-w-2xl mx-auto">
      <div class="mx-4 px-4 py-6 bg-gray-800 rounded-lg">
        ...
        <div class="flex flex-col mb-4">
          <label class="flex flex-col text-purple-500">Username</label>
          <div class="flex items-center">
            <ArrowNarrowRightIcon class="h-5 w-5 text-pink-500 mr-2" />
            <input class="w-full bg-transparent outline-none" type="text" v-model="params.name" />
          </div>
        </div>
        <div class="flex flex-col mb-4">
          <label class="flex flex-col text-purple-500">Email</label>
          <div class="flex items-center">
            <MailIcon class="h-5 w-5 text-pink-500 mr-2" />
            <input class="w-full bg-transparent outline-none" type="text" v-model="params.email" />
          </div>
        </div>
        <div class="flex flex-col mb-4">
